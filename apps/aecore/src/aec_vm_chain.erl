...
-spec new_offchain_state(aec_trees:trees(), aesc_channels:seq_number(),
                         aec_keys:pubkey()) -> chain_state().
new_offchain_state(OffChainTrees, Round, ContractAccount) ->
    State = new_state(OffChainTrees, Round, ContractAccount),
