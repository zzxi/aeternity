...
extra_nonce_cache() ->
    ExtraNonceBytes = get_env(extra_nonce_bytes, 4),
    MaxExtraNonce   = aestratum_utils:max_extra_nonce(ExtraNonceBytes),
    {aestratum_extra_nonce_cache,
     {aestratum_extra_nonce_cache, start_link, [MaxExtraNonce]},
